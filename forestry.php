...
?>
            ...
            <form action="forestry.php" method="POST" class="container-fluid p-0 w-100  px-3 col ">


                <div>
                    <div class="header position-sticky top-0 shadow">
                        <div class="title text-center  py-2" style="background:black;color:white;">
                        <h4 class="m-0 py-3 page_title">ECONOMIC DEVELOPMENT SECTOR / FORESTRY</h4>
                        </div>
                    ...
                    <div class="row mt-3 " id="parent_accordion">
                        <div class="accordion" id="forestry">
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingOne">
                                    <button class="accordion-button d-flex justify-content-between shadow" type="button"
                                        ...
                                        <h6 class="p-0"> Women who participated in the management of protected areas
                                    ...
                                    <table class="w-25 m-auto mb-3 my-3  p-4 " id="printcontent">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center ">
                                                <textarea type="text" name="text7" class="py-2 px-3"
                                                    style="width:500px;min-height:200px"
                                                    placeholder="Enter text"> <?php  echo  isset($rowresult) ?  $rowresult["text7"] : '';  ?></textarea>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingOne">
                                    <button class="accordion-button d-flex justify-content-between shadow" type="button"
                                        ...
                                        <h6 class="p-0"> Marine and terrestrial protected areas managed by women
                                            (MCW-IRR Sec. 23 B 5)
                                        </h6>
                                        <span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24">
                                ...
                                <div id="accordiontwo" class="accordion-collapse collapse show"
                                    ...
                                    <table class="w-25 m-auto mb-3 my-3  p-4 " id="printcontent">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center ">
                                                <textarea type="text" name="text8" class="py-2 px-3"
                                                    style="width:500px;min-height:200px"
                                                    placeholder="Enter text"> <?php  echo  isset($rowresult) ?  $rowresult["text8"] : '';  ?></textarea>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="headingOne">
                                    <button class="accordion-button d-flex justify-content-between shadow" type="button"
                                        ...
                                        <h6 class="p-0"> Community managed ecotourism projects participated in by women
                                            stakeholders (MCW-IRR Sec. 23 B 5.b)
                                        </h6>
                                        <span><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                viewBox="0 0 24 24">
                                                <path
                                ...
                                <div id="accordionthree" class="accordion-collapse collapse show"
                                    ...
                                    <table class="w-25 m-auto mb-3 my-3  p-4 " id="printcontent">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center ">
                                                <textarea type="text" name="text9" class="py-2 px-3"
                                                    style="width:500px;min-height:200px"
                                                    placeholder="Enter text"> <?php  echo  isset($rowresult) ?  $rowresult["text9"] : '';  ?> </textarea>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
