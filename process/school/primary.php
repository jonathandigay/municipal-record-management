...
<<<<<<< HEAD
    $dbconnection->query("INSERT INTO primary_education (schoolYear,schoolName,m1,f1,m2,f2,num1,m3,f3,num2,m4,f4) VALUES ('$school_year','$school_name',$m1,$f1,$m2,$f2,$num1,$m3,$f3,$num2,$m4,$f4)");
=======
