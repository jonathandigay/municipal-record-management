                ...
                <div class="header position-sticky top-0 shadow">
                    ...
                    <div class=" d-flex my-2 align-items-center  ">
                        ...
                        <div class="d-flex justify-content-end">
                            <a href="../dashboard.php" id="view_chart_btn">
                                <button style="background:rgb(255,62,143);color:white;" class="py-2 px-3 m-2 shadow "
                                    type="button"> dashboard <svg width="24" height="24"
                                        xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" fill="#fff"
                                        clip-rule="evenodd">
                                        <path
