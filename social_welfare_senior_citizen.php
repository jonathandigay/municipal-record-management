...
?>
            ...
            <form action="social_welfare_senior_citizen.php" method="POST" class="container-fluid p-0 w-100  px-3 col ">


                <div>
                    <div class="header position-sticky top-0 shadow">
                        <div class="title text-center  py-2" style="background:black;color:white;">
                        <h4 class="m-0 py-3 page_title">SOCIAL DEVELOPMENT SECTOR / SOCIAL WELFARE SENIOR CITIZEN
                            </h4>
                        </div>
                                    ...
                                    <table class="w-25 m-auto mb-3 my-3  p-4 " id="printcontent">
                                        <tr>
                                            <td class="text-center"><input type="text"
                                                    ...
                                                    value="<?php  echo  isset($rowresult) ?  $rowresult["num14"] : 0;  ?>"
                                                    name="num14" id="" />
                                            </td>
                                        </tr>
                                    </table>
