...
?>
            ...
            <form action="tenure_management.php" method="POST" class="container-fluid p-0 w-100  px-3 col ">


                <div>
                    <div class="header position-sticky top-0 shadow">
                        <div class="title text-center  py-2" style="background:black;color:white;">
                            <h5 class="m-0 py-3 page_title"> Resources base and land use Sector / Tenure Management</h5>
                        </div>
                                    ...
                                    <table class="w-25 m-auto mb-3 my-3  p-4 " id="printcontent">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center ">
                                                <textarea type="text" name="text11" class="py-2 px-3"
                                                    style="width:500px;min-height:200px"
                                                    placeholder="Enter text"> <?php  echo  isset($rowresult) ?  $rowresult["text11"] : "";  ?></textarea>
                                            </td>
                                        </tr>
                                    </table>
                                </div>
                                    ...
                                    <table class="w-25 m-auto mb-3 my-3  p-4 " id="printcontent">
                                        <tr>
                                            <td class="text-center"><input type="text"
                                                    ...
                                                    value="<?php  echo  isset($rowresult) ?  $rowresult["num24"] : 0;  ?>"
                                                    name="num24" id="" />
                                            </td>
                                        </tr>
                                    </table>
                                ...
                                <div id="sexindex" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                                    ...
                                    <table class="w-75 m-auto mb-3 my-3  p-4 " id="printcontent">
                                        ...
                                        <tr>
                                            ...
                                            <td> <input type="text" name="m75" id=""
                                                    onkeypress="return onlyNumberKey(event)"
                                                    value="<?php  echo  isset($rowresult) ?  $rowresult["m75"] : 0;  ?>" />
                                            </td>
                                            <td> <input type="text" name="f75" id=""
                                                    onkeypress="return onlyNumberKey(event)"
                                                    value="<?php  echo  isset($rowresult) ?  $rowresult["f75"] : 0;  ?>" />
                                            </td>
                                        </tr>
                                    </table>
                                </div>
