...
?>
        ...
        <br>
        <h2 style="font-weight:500;text-align:center" class="text-center">TERTIARY EDUCATION </h2>
        ...
        <div style="max-width:1000px;margin:auto;display:flex;justify-content:space-between;flex-wrap">
            <div style="display:flex;">
                ...
                <span><?php  echo  isset($tertiary_row) ?  $tertiary_row["schoolName"] : "";  ?></span>
            </div>

            <div style="display:flex">
                <h4 style="padding:0 10px 0 0">School Year:</h4>
                <span><?php  echo  isset($tertiary_row) ?  $tertiary_row["schoolYear"] : "";  ?></span>
            </div>
        ...
        <section>
            <h4 style="padding:10px">Ratio of girls to boys in tertiary education</h4>
            <div class="row_pair_table table">
                ...
                <div class="row_pair row">
                    <div class="col" style="text-align:center;">
                        <p class="box"><?php  echo  isset($tertiary_row) ?  $tertiary_row["m1"] : 0;  ?></p>
                    </div>

                    <div class="col">
                        <p class="box"><?php  echo  isset($tertiary_row) ?  $tertiary_row["f1"] : 0;  ?></p>
                    </div>
                    <div class="col">
                        <p class="box">
                            <?php  echo  isset($tertiary_row) ?  $tertiary_row["m1"] + $tertiary_row["f1"]  : 0;  ?></p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section>
            ...
            <div class="row_pair_table table">
                ...
                <div class="row_pair row">
                    <div class="col" style="text-align:center;">
                        <p class="box"><?php  echo  isset($tertiary_row) ?  $tertiary_row["m2"] : 0;  ?></p>
                    </div>

                    <div class="col">
                        <p class="box"><?php  echo  isset($tertiary_row) ?  $tertiary_row["f2"] : 0;  ?></p>
                    </div>
                    <div class="col">
                        <p class="box">
                            <?php  echo  isset($tertiary_row) ?  $tertiary_row["m2"] + $tertiary_row["f2"]  : 0;  ?></p>
                    </div>
                </div>
            </div>
        </section>
