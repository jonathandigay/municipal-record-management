...
<body>
    ...
    <div class="main">
        ...
        <br>
        <h2 style="font-weight:500;text-align:center" class="text-center">SECONDARY EDUCATION </h2>
        ...
        <div style="max-width:1000px;margin:auto;display:flex;justify-content:space-between;flex-wrap">
            <div style="display:flex;">
                ...
                <span><?php  echo  isset($secondary_row) ?  $secondary_row["schoolName"] : "";  ?></span>
            </div>

            <div style="display:flex">
                <h4 style="padding:0 10px 0 0">School Year:</h4>
                <span><?php  echo  isset($secondary_row) ?  $secondary_row["schoolYear"] : "";  ?></span>
            </div>
        ...
        <section>
            <h4 style="padding:10px">Ratio of girls to boys in secondary education</h4>
            <div class="row_pair_table table">
                ...
                <div class="row_pair row">
                    <div class="col" style="text-align:center;">
                        <p class="box"><?php  echo  isset($secondary_row) ?  $secondary_row["m1"] : 0;  ?></p>
                    </div>

                    <div class="col">
                        <p class="box"><?php  echo  isset($secondary_row) ?  $secondary_row["f1"] : 0;  ?></p>
                    </div>
                    <div class="col">
                        <p class="box">
                            <?php  echo  isset($secondary_row) ?  $secondary_row["m1"] + $secondary_row["f1"]  : 0;  ?>
                        </p>
                    </div>
                </div>
            </div>
        ...
        <section>
            ...
            <div class="row_pair_table table">
                ...
                <div class="row_pair row">
                    <div class="col" style="text-align:center;">
                        <p class="box"><?php  echo  isset($secondary_row) ?  $secondary_row["m2"] : 0;  ?></p>
                    </div>

                    <div class="col">
                        <p class="box"><?php  echo  isset($secondary_row) ?  $secondary_row["f2"] : 0;  ?></p>
                    </div>
                    <div class="col">
                        <p class="box">
                            <?php  echo  isset($secondary_row) ?  $secondary_row["m2"] + $secondary_row["f2"]  : 0;  ?>
                        </p>
                    </div>
                </div>
            </div>
        ...
        <section>
            ...
            <div class="row_pair_table table">
                ...
                <div class="row_pair row">
                    <div class="col" style="text-align:center;">
                        <p class="box"><?php  echo  isset($secondary_row) ?  $secondary_row["m3"] : 0;  ?></p>
                    </div>

                    <div class="col">
                        <p class="box"><?php  echo  isset($secondary_row) ?  $secondary_row["f3"] : 0;  ?></p>
                    </div>
                    <div class="col">
                        <p class="box">
                            <?php  echo  isset($secondary_row) ?  $secondary_row["m3"] + $secondary_row["f3"]  : 0;  ?>
                        </p>
                    </div>
                </div>
            </div>
        ...
        <section>
            ...
            <div class="row_pair_table table">
                ...
                <div class="row_pair row">
                    <div class="col" style="text-align:center;">
                        <p class="box"><?php  echo  isset($secondary_row) ?  $secondary_row["m4"] : 0;  ?></p>
                    </div>

                    <div class="col">
                        <p class="box"><?php  echo  isset($secondary_row) ?  $secondary_row["f4"] : 0;  ?></p>
                    </div>
                    <div class="col">
                        <p class="box">
                            <?php  echo  isset($secondary_row) ?  $secondary_row["m4"] + $secondary_row["f4"]  : 0;  ?>
                        </p>
                    </div>
                </div>
            </div>
